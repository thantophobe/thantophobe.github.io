...
$(function () {
    ...
    $window.on("scroll.mySkills-1", function () {
        if ($(this).scrollTop() >= $(".my-skills-boxs div:first-of-type").offset().top - $window.height() + 200) {
    ...
    $window.on("scroll.mySkills-2", function () {
        if ($(this).scrollTop() >= $(".my-skills-boxs div:nth-of-type(2)").offset().top - $window.height() + 200) {
    ...
    $window.on("scroll.mySkills-3", function () {
        if ($(this).scrollTop() >= $(".my-skills-boxs div:nth-of-type(3)").offset().top - $window.height() + 200) {
    ...
    $window.on("scroll.mySkills-4", function () {
        if ($(this).scrollTop() >= $(".my-skills-boxs div:last-of-type").offset().top - $window.height() + 200) {
    ...
    $(".portfolio-lightbox i").on("click", function () {
        $(".portfolio-lightbox").fadeOut();
    });
    ...
    // overlay to Disable scrolling zoom in google maps iframe
    
    $(".contact-map .map .map-overlay").on("click", function () {
        $(this).hide(0).delay(3000).show(0);
    });
